                        ...
                        <form action="{{ route('profile.store') }}" method="post">@csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="blood_type" class="form-control @error('blood_type') is-invalid @enderror">
                                    ...
                                    <option value="male" @if ($user->blood_type === 'A+')selected @endif
                                        >A+</option>
                                    <option value="female" @if ($user->blood_type === 'AB+')selected @endif
                                        >AB+</option>
                                        <option value="male" @if ($user->blood_type === 'B')selected @endif
                                        >B</option>
                                        <option value="male" @if ($user->blood_type === 'AB-')selected @endif
                                        >AB-</option>
                                        <option value="male" @if ($user->blood_type === 'O-')selected @endif
                                        >O-</option>
                                        <option value="male" @if ($user->blood_type === 'O+')selected @endif
                                        >O+</option>
                                </select>
